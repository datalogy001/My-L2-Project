...
export class LoginPage implements OnInit {
  ...
  constructor(private signInWithApple1: SignInWithApple, private keyboard: Keyboard, private translate: TranslateService, private googlePlus: GooglePlus, private loadingScreen: LoadingScreenAppPage, private http: HttpClient, private modalController: ModalController, private platform: Platform, private loadCtr: LoadingController, private service: ServicesService, private Router: Router, private navController: NavController, private toastController: ToastController) {
  }
  ...
  async signInWithAppleFunSuccess(appleRes: any) {
    ...
    this.service.appleSignIn(this.appleLoginObj).then((resNew: any) => {
      ...
      if (resNew['code'] == 200) {
        ...
        window.localStorage.setItem('L2TraveleSIM_loginType', "apple");
